...
public class SXls {
	...
	public static SExcel read(byte[] file) {
		...
		try {
			...
			workbook = new HSSFWorkbook(new ByteArrayInputStream(file));
...
//	}
	...
	public static byte[] write(
		...
		HSSFWorkbook read_workbook = null;
		try {
			
			byteArrayInputStream = new ByteArrayInputStream(read_bytes);
			byteArrayOutputStream = new ByteArrayOutputStream();
			read_workbook = new HSSFWorkbook(byteArrayInputStream);
...
//			write_sheet_cells(read_sheet, sheet_data);
	...
	private static int write_sheet_rows(
		...
		HSSFRow write_row = null;
		int cell_no = 0;
		HSSFCell write_cell = null;
